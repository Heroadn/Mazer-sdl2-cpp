...
/**
 *  \brief  A variable controlling whether to enable Direct3D 11+'s Cursor Layer.
 *
 *  This variable does not have any effect on the Direct3D 9 based renderer.
 *
 *  This variable can be set to the following values:
 *    "0"       - Disable Cursor Layer use
 *    "1"       - Enable Cursor Layer use
 *
 *  By default, SDL does not use Direct3D Cursor Layer.
 */
